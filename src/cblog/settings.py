...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.c5llqlfhbui3.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesule' # please enter your s3 bucket name
